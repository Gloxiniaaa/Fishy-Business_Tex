...
%Title page
\title[Đồ Án Tốt Nghiệp HK252] %optional
{\vspace*{1cm}\\\textbf{\large BÁO CÁO ĐỒ ÁN TỐT NGHIỆP}}

\subtitle{\textbf{\Large PHÁT TRIỂN GAME FISHY-BUSINESS}}

\author[Nhóm Fishy-Business] % (optional)Hội Đồng: 14L
{\textbf{Hội Đồng:} 4L Khoa học Máy tính\\
\textbf{Mã Đề tài:} HK252-DATN-406 \\
...
\input{sec/Gioi_thieu.tex}  % 1
\input{sec/saboteur.tex}
\input{sec/van_de.tex}      % 4
\input{sec/Yeu_cau.tex}     % 3
\input{sec/giai_phap.tex}

\input{sec/tien_do.tex}   % 6
\input{sec/danh_gia.tex}

% \input{sec/khao_sat.tex}  % 8
% \input{sec/luat_choi.tex}   % 2
% \input{sec/use_case_diagram.tex}    % 5
% \input{sec/demo.tex}      % 7
...
\begin{frame}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.2\linewidth]{saboteur/qrcode.png}
        \caption*{https://fishy-business-website.vercel.app}
    \end{figure}
    \vspace{0.5cm}
    \textbf{\Huge{- THE END - }}\\
    \vspace{0.2cm}
