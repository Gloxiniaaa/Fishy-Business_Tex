...
\begin{columns}
    ...
    \begin{itemize}
        \item Thêm chế độ chơi mới kết hợp giữa saboteur gốc và chế độ ngày đêm, voting của ma sói.
    ...
    \begin{itemize}
        \item Thêm map mới: battle ship với không gian là trên con thuyền giữa biển khơi, tạo cảm giác tự do, phiêu lưu.
        \item Có thể chọn qua lại giữa 2 map khi tạo phòng chơi.
    \end{itemize}
\end{columns}
\end{frame}
