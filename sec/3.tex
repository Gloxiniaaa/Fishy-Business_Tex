% =========================================================
\section{III. Các Vấn Đề \& Giải Pháp}
% =========================================================
...
\end{itemize}
\vspace{0.5cm}
\textbf{Lựa chọn (Giai đoạn 1): Client-Host}
\begin{itemize}
    \item Tối ưu tốc độ phát triển và chi phí (không cần thuê server).
    \item Phù hợp thử nghiệm gameplay, dễ debug.
    \item \textit{Định hướng Giai đoạn 2: Chuyển sang Dedicated Server để tăng ổn định}.
\end{itemize}
\end{frame}

% SLIDE 13: Hệ Thống Voice Chat
\begin{frame}
\frametitle{Hệ Thống Voice Chat: Vivox}
\textbf{So sánh:}
\begin{itemize}
    \item \textbf{Dissonance:} Tùy biến cao, trả phí (Asset Store), cần tự setup backend.
    \item \textbf{Photon Voice:} Tốt cho game realtime nhưng thường đi kèm gói trả phí của Photon.
...
\begin{itemize}
    ...
    \item API dễ tích hợp, hỗ trợ channel-based chat.
\end{itemize}
\end{frame}
